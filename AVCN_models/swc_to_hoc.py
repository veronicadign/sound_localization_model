...
files in AVCN_models/morphology/dryad/ (``create sections[N]`` +
...
Usage
-----
  python AVCN_models/swc_to_hoc.py \
      --swc S113.CNG.swc \
      --out AVCN_models/morphology/neuromorpho/SBC_S113.hoc
"""
...
# syGlass SectionList names, matching AVCN_models/morphology/dryad/*.hoc and the
...
def write_hoc(out, out_path, src_name):
    ...
    L = []
    L.append('//')
    L.append('//  Converted from NeuroMorpho SWC by AVCN_models/swc_to_hoc.py')
