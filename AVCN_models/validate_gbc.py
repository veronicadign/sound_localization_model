...
Usage:
  /home/verodige/miniforge3/envs/sl_env/bin/python AVCN_models/validate_gbc.py \
      [--morphology AVCN_models/morphology/bushy_stick.hoc]

Saves AVCN_models/figures/gbc_iclamp_validation.png
"""
import os
import argparse
...
def main():
    ...
    try:
        neuron.load_mechanisms(HERE)      # AVCN_models/x86_64 (may be auto-loaded from CWD)
    ...
    soma_density = gb.decorate_gbc(verbose=True, ref_ns=ref_ns)
