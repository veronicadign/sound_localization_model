...
Loads MNTB_models/calyx_model.hoc, inserts NEURON's `extracellular` mechanism on
...
Usage:
  /home/verodige/miniforge3/envs/sl_env/bin/python MNTB_models/validate_calyx.py

Saves MNTB_models/figures/calyx_prespike_validation.png (+ stdout PASS/FAIL).
"""
import os
import argparse
...
def main():
    ...
    _load(os.path.join(REPO_ROOT, 'MNTB_models'))    # namntb
