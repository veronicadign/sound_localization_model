function train = pulsetrain_fordisplay(ppspattern,pps,maxima,sfreq_pulsepattern,CIParams)
...
biphasic_pulse = [ones(1,round(CIParams.Tph*sfreq_pulsepattern)) ... 
    zeros(1,round(CIParams.ipg*sfreq_pulsepattern)) ones(1,round(CIParams.Tph*sfreq_pulsepattern)).*(-1)];
